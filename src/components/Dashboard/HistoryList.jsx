export default function HistoryList({ transactions, loading, onSeeAll }) {
  return (
    <div className="px-5 mt-8">
      <div className="flex items-end justify-between px-1 mb-4">
        <h3 className="text-lg font-black text-gray-800">Riwayat Cuan</h3>
        <button onClick={onSeeAll} className="text-xs font-black text-blue-600 uppercase">Semua</button>
      </div>
