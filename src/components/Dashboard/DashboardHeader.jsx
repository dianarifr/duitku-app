    ...
    <div className="relative px-6 pt-12 overflow-hidden text-white bg-blue-600 shadow-lg pb-14 rounded-b-4xl">
      ...
      <div className="relative z-10 flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[10px] font-black tracking-[0.2em] text-blue-100 uppercase opacity-80">Halo, bosku! 👋</p>
            <h2 className="text-lg font-black tracking-tight capitalize truncate w-44">{userName}</h2>
          </div>
        </div>
        <button onClick={onLogout} className="px-3 py-1.5 bg-white/20 rounded-xl text-[10px] font-black uppercase tracking-widest active:scale-95 transition-transform">Logout</button>
      </div>
      ...
      <div className="flex justify-center mt-3">
        <p className="px-3 py-1 bg-black/10 rounded-full text-[9px] font-black text-white/70 uppercase tracking-widest border border-white/5">
          Periode: {periodLabel}
        </p>
      </div>
    </div>
